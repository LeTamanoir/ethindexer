...
func (i *Indexer[S]) Sync(ctx context.Context) error {
	if i.head != nil {
...
func (i *Indexer[S]) syncFinalized(ctx context.Context) error {
...
func (i *Indexer[S]) backfillFinalized(ctx context.Context, from, to uint64) error {
